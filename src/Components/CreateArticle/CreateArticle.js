  ...
  handleLocationBoxes = () => {
    ...
    for (let i in checked) {
      checked[i].checked === true
        ? locationResults.push(checked[i].value)
        : null;
    }
  ...
  render() {
    return (
      <div className="articleCreation">
        <div className="templateTitle">New Article Template</div>
        <div className="title">
          <br />
        ...
        <div className="systems">
          ...
          <form onChange={e => this.props.handleSystemsChange(e.target.value)}>
            ...
            <input
              ...
              name="systems"
              value="3ds"
              checked={this.props.systems.threeDS}
              onClick={this.handleSystemBoxes}
            />
            3DS
            <br />
            <input
              ...
              name="systems"
              value="switch"
              checked={this.props.systems.switch}
              onClick={this.handleSystemBoxes}
            />
            SWITCH
            <br />
            <input
              ...
              name="systems"
              value="ps4"
              checked={this.props.systems.ps4}
              onClick={this.handleSystemBoxes}
            />
            PLAYSTATION 4<br />
            <input
              ...
              name="systems"
              value="ps3"
              checked={this.props.systems.ps3}
              onClick={this.handleSystemBoxes}
            />
            PLAYSTATION 3<br />
            <input
              ...
              name="systems"
              value="vita"
              checked={this.props.systems.vita}
              onClick={this.handleSystemBoxes}
            />
            VITA <br />
            <input
              ...
              name="systems"
              value="psp"
              checked={this.props.systems.psp}
              onClick={this.handleSystemBoxes}
            />
            PSP <br />
            <input
              ...
              name="systems"
              value="ios"
              checked={this.props.systems.ios}
              onClick={this.handleSystemBoxes}
            />
            iPHONE
            <br />
            <input
              ...
              name="systems"
              value="xOne"
              checked={this.props.systems.xOne}
              onClick={this.handleSystemBoxes}
            />
            XBOX ONE
            <br />
            <input
              ...
              name="systems"
              value="x360"
              checked={this.props.systems.x360}
              onClick={this.handleSystemBoxes}
            />
            XBOX 360
            <br />
            <input
              ...
              name="systems"
              value="interviews"
              checked={this.props.systems.interviews}
              onClick={this.handleSystemBoxes}
            />
            INTERVIEW
            <br />
          ...
          <div className="location">
            <br />
            <form
              onChange={e => this.props.handleLocationsChange(e.target.value)}
            >
              ...
              <input
                ...
                name="locations"
                value="japan"
                checked={this.props.locations.japan}
              />
              Japan
              <br />
              <input
                ...
                name="locations"
                value="northAmerica"
                checked={this.props.locations.northAmerica}
              />
              North America
              <br />
              <input
                ...
                name="locations"
                value="europe"
                checked={this.props.locations.europe}
              />
              Europe
              <br />
            </form>
